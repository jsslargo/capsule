...
| **Conformance (15/15)** | **:white_check_mark: 15/15** | **:white_check_mark: 15/15** |
...
New language implementations import `conformance/fixtures.json` from this repo and pass all 15 golden vectors independently.

---

## Conformance Requirement

Every reference implementation must pass all 15 golden test vectors in [`conformance/fixtures.json`](../conformance/fixtures.json). An implementation is conformant when it produces byte-identical canonical JSON and matching SHA3-256 hashes for every fixture.
...
2. Pass all 15 conformance fixtures
